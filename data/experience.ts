...
export const experience = [
  ...
  },
  {
    ...
    company: 'XSOL DATA SYSTEM PVT LTD',
    url: '',
    position: 'ASP.NET & Node.js Developer',
    location: 'India',
    description: [
    ...
    tools: ['ASP.NET', 'Node.js', 'MSSQL', 'Windows Web Server (IIS)'],
  },
  {
    id: _.uniqueId(),
    timeline: 'Aug 2022 - May 2023',
    company: 'Infotech Software Solutio',
    url: '',
    ...
    tools: ['ASP.NET', 'HTML 5', 'CSS 3', 'Bootstrap', 'MSSQL'],
  },
  {
    id: _.uniqueId(),
    ...
    tools: ['HTML 5', 'CSS 3', 'Bootstrap 5', 'JavaScript'],
  },
];

      ...
      return {
        response: (
          <div className="whitespace-pre-wrap">
            <span>total 0</span>
            <br />
            <span className="text-green-500">drwxr-xr-x</span> 2 keshavjatt
            keshavjatt 4096 Jul 1 10:00{' '}
            <span className="text-yellow-500">Desktop</span>
            <br />
            <span className="text-green-500">drwxr-xr-x</span> 2 keshavjatt
            keshavjatt 4096 Jul 1 10:00{' '}
      ...
      {terminalRows.map((row, index) => (
        <Fragment key={index}>
          <div className="mb-1 flex items-center">
            <span className="font-bold text-green-500">keshavjatt@ubuntu</span>
